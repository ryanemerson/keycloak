...
package org.keycloak.health.xsite;
 ...
 *
 */
public interface XSiteCheckProvider extends Provider {
     ...
     * is complete.
     *
     * @return true if the requested site is offline, false otherwise
     */
    boolean isDown(String site);
}
