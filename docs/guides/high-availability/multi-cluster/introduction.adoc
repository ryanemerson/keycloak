...
Those setups are intended for a transparent networks.

// TODO: add link to the other introduction

A multi-cluster setup adds additional options, that extra amount of high availability may be needed for some environments.
...
Read more on each item in the <@links.ha id="multi-cluster-bblocks-multi-site" /> {section}.
...
For more details on limitations see the <@links.ha id="multi-cluster-concepts-multi-site" /> {section}.
...
* <@links.ha id="multi-cluster-concepts-multi-site" />
* <@links.ha id="multi-cluster-bblocks-multi-site" />
...
* <@links.ha id="multi-cluster-deploy-aurora-multi-az" />
...
* <@links.ha id="multi-cluster-health-checks-multi-site" />
