...
This deployment is intended to be used with the setup described in the <@links.ha id="multi-cluster-concepts-multi-cluster"/> {section}.
Use this deployment with the other building blocks outlined in the <@links.ha id="multi-cluster-bblocks-multi-cluster"/> {section}.
...
[#multi-cluster-establish-peering-connections-with-rosa-clusters]
