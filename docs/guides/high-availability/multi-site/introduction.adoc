...
Read more on each item in the <@links.ha id="multi-site-bblocks-multi-site" /> {section}.

[#multi-site-load]
<#include "/high-availability/partials/tested-load.adoc" />

See the <@links.ha id="multi-site-concepts-memory-and-cpu-sizing" /> {section} for more information.
...
For more details on limitations see the <@links.ha id="multi-site-concepts-multi-site" /> {section}.
...
* <@links.ha id="multi-site-concepts-multi-site" />
* <@links.ha id="multi-site-bblocks-multi-site" />
* <@links.ha id="multi-site-concepts-database-connections" />
* <@links.ha id="multi-site-concepts-threads" />
* <@links.ha id="multi-site-concepts-memory-and-cpu-sizing" />
* <@links.ha id="multi-site-concepts-infinispan-cli-batch" />

== Blueprints for building blocks

* <@links.ha id="multi-site-deploy-aurora-multi-az" />
* <@links.ha id="multi-site-deploy-infinispan-kubernetes-crossdc" />
* <@links.ha id="multi-site-deploy-keycloak-kubernetes" />
* <@links.ha id="multi-site-deploy-aws-accelerator-loadbalancer" />
* <@links.ha id="multi-site-deploy-aws-accelerator-fencing-lambda" />

== Operational procedures

* <@links.ha id="multi-site-operate-synchronize" />
* <@links.ha id="multi-site-operate-site-offline" />
* <@links.ha id="multi-site-operate-site-online" />
* <@links.ha id="multi-site-health-checks-multi-site" />
