...
See the <@links.ha id="multisiteconcepts-memory-and-cpu-sizing" /> {section} for more information.
...
* <@links.ha id="multisiteconcepts-database-connections" />
* <@links.ha id="multisiteconcepts-threads" />
* <@links.ha id="multisiteconcepts-memory-and-cpu-sizing" />
* <@links.ha id="multisiteconcepts-infinispan-cli-batch" />

== Blueprints for building blocks

* <@links.ha id="multi-sitedeploy-aurora-multi-az" />
* <@links.ha id="multi-sitedeploy-infinispan-kubernetes-crossdc" />
* <@links.ha id="multi-sitedeploy-keycloak-kubernetes" />
* <@links.ha id="multi-sitedeploy-aws-accelerator-loadbalancer" />
* <@links.ha id="multi-sitedeploy-aws-accelerator-fencing-lambda" />

== Operational procedures

* <@links.ha id="multi-siteoperate-synchronize" />
* <@links.ha id="multi-siteoperate-site-offline" />
* <@links.ha id="multi-siteoperate-site-online" />
* <@links.ha id="multi-sitehealth-checks-multi-site" />
