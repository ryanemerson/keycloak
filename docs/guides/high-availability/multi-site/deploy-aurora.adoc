...
<#import "../partials/aurora/aurora-architecture.adoc" as aurora />
...
<@aurora.architecture "multi-site" />

[#multi-site-aurora-procedure]
== Procedure
...
After successful deployment of the Aurora database continue with <@links.ha id="multi-site-deploy-infinispan-kubernetes-crossdc" />
