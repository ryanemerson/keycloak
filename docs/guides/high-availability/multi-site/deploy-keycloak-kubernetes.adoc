...
. Notice the configuration file below contains options relevant for connecting to the Aurora database from <@links.ha id="multi-site-deploy-aurora-multi-az" anchor="multi-site-aurora-connecting" />
