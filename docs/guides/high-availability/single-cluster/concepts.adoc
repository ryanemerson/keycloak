...
// TODO: Maybe we need a different statement for upstream
To provide a more concrete example, the following chapter assume a deployment contained within a single Kubernetes cluster.
