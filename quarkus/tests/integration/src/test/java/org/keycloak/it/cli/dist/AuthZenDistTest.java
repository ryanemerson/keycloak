...
public class AuthZenDistTest {
    ...
    private static final String AUTHZEN_HTTPS_ERROR = "The AuthZen endpoint requires HTTPS in order to be compliant with the OpenID AuthZen specification.";

    @Test
    @Launch({Start.NAME, "--db=dev-file", "--features=authzen", "--http-enabled=true", "--hostname-strict=false"})
    public void testHttpEnabledWarnsInProductionMode(CLIResult cliResult) {
